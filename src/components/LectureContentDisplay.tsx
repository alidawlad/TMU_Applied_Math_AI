...
import type { Lecture, Module, LectureContent, LectureContentSegment } from '@/lib/types';
...
export function LectureContentDisplay({ lecture, module, content }: LectureContentDisplayProps) {
  ...
  return (
    <div className="flex flex-col h-screen font-sans bg-muted/20">
